...
- [x] Confirmar com uma sessão ROOT renovada o envio de capa e sua persistência no curso após a publicação da correção.
...
- [x] Cobrir a validação de capa de plano e confirmar o salvamento pelo formulário mobile.
...
- [x] Diagnosticar e corrigir a exibição do selo “Conteúdo novo” ou “Conteúdo atualizado” para alunos com matrícula elegível.
...
- [x] Registrar todas as alterações atuais em um commit Git seguro, sem credenciais nem artefatos locais.
- [x] Enviar o commit completo para o repositório remoto e confirmar a branch publicada.
