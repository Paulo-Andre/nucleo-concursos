...
export function AlertAdminPanel() {
  ...
  const createAlert = trpc.admin.alerts.create.useMutation({
    onSuccess: () => { setTitle(""); setMessage(""); setAudience("all"); setCourseId(""); setFeedback("Alerta enviado e disponível para o público selecionado."); void utils.admin.alerts.list.invalidate(); },
  ...
  function submit(event: React.FormEvent) {
    ...
    setFeedback(null);
    createAlert.mutate({ level, title, message, audience, courseId: audience === "course" ? courseId : null });
  }
